...
async function onSave() {
  ...
  try {
    if (isNew) {
      ...
      toast.add({
        severity: 'success',
        summary: t('page.admin.familyId.categories.id.success'),
        detail: t('page.admin.familyId.categories.id.createSuccess'),
        life: 3000,
      })
    }
    else {
      ...
      toast.add({
        severity: 'success',
        summary: t('page.admin.familyId.categories.id.success'),
        detail: t('page.admin.familyId.categories.id.editSuccess'),
        life: 3000,
      })
    }
  }
    ...
    toast.add({
      severity: 'error',
      summary: t('page.admin.familyId.categories.id.error'),
      detail: t('page.admin.familyId.categories.id.editError'),
      life: 3000,
    })
  }
